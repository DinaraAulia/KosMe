...
<head>
    ...
    <style>
        ...
        .form-control, .btn, .login-header, .divider, .form-check, .signup-text {
        ...
        .form-check, .forgot-password-container {
        ...
        <div class="login-container">
            <div class="login-form-container col-lg-6">
                ...
                <form>
                    ...
                    <button type="button" class="btn btn-google w-100 py-2 mb-2 google-button">
                        <img src="https://cdnjs.cloudflare.com/ajax/libs/simple-icons/6.0.0/google.svg" alt="Google" width="16" height="16">
                        Lanjutkan dengan Google
                    </button>
                    
                    <p class="text-center signup-text">Belum punya akun? <a href="/register" class="signup-link">Daftar sekarang</a></p>
                </form>
            </div>
        </div>
    </div>
